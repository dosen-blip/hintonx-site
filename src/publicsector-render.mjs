...
export function publicSectorVisual(media, {label = 'Project image pending', eager = false, sizes = '(min-width: 1320px) 1240px, (max-width: 380px) calc(100vw - 32px), (max-width: 760px) calc(100vw - 40px), calc(100vw - 80px)', logo = false} = {}) {
